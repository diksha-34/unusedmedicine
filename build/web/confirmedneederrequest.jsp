...
<head>
    ...
    <title>State Level Trust - Confirmed needer's request list</title>
    <style>
        body {
...
<body>
    ...
    <center><h1 style="margin-top: 8%;">Confirmed needer's request list</h1></center>
    ...
    <table>
        ...
        <% 
            ...
            try{
                ...
                try{
                    PreparedStatement mystatement = myConnection.prepareStatement("select * from cart inner join donate where cart.medicineid=donate.donarid and cart.status='confirm'");
