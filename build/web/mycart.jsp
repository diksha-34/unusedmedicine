...
<body>
    ...
    <table>
        ...
        <%
            ...
            <td><a href="incDecQuantityAction.jsp?id=<%= myresult.getString(1)%>&quantity=inc"><i class='fa-solid fa-circle-plus mx-2'></i></a><%=myresult.getString(12)%><a href="incDecQuantityAction.jsp?id=<%= myresult.getString(1)%>&quantity=dec"><i class='fa-solid fa-circle-minus mx-2'></i></a></td>
